...
public interface PostulacionRepository extends JpaRepository<Postulacion, Long> {
    ...
    Page<Postulacion> findByEstadoAndTipoPostulacionOrderByFechaCreacionDesc(EstadoPostulacion estado, TipoPostulacion tipo, Pageable pageable);
    ...
    Page<Postulacion> buscarPaginado(@Param("texto") String texto, Pageable pageable);
}
